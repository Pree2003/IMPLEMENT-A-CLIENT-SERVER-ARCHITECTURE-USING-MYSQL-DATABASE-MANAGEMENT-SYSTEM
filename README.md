...
The MySQL Server configuration file (mysqld.cnf) was reviewed using the sudo cat /etc/mysql/mysql.conf.d/mysqld.cnf 
command to examine the server's default configuration settings. 
